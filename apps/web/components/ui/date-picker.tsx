        ...
        >
          <DayPicker
            ...
            classNames={{
              ...
              month_caption: "flex items-center justify-center relative h-9 pointer-events-none",
              caption_label: "text-sm font-semibold pointer-events-auto",
              nav: "absolute inset-x-0 top-0 z-20 flex items-center justify-between px-1 pointer-events-none",
              button_previous: "pointer-events-auto inline-flex size-7 items-center justify-center rounded-md text-slate-600 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800 cursor-pointer z-30",
              button_next: "pointer-events-auto inline-flex size-7 items-center justify-center rounded-md text-slate-600 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800 cursor-pointer z-30",
